...
if __name__ == "__main__":
    ...
    altControl = PIDcontrol.PIDControl('Alt', Kp =30, Ki = 6, Kd = 28, timeStep = dt, open = False)
    rollControl = PIDcontrol.PIDControl('Roll', Kp = 8, Ki = 6, Kd = 8, timeStep = dt, open = False)
    pitchControl = PIDcontrol.PIDControl('Pitch', Kp = 8, Ki = 6, Kd = 8, timeStep = dt, open = False)
    yawControl = PIDcontrol.PIDControl('Yaw', Kp = 600, Ki = 0, Kd = .1, timeStep = dt, open = False)
    ...
    while t < 50:
        ...
        x_next, currU = ds.numericalIntegrationWithU(x, errs, dt)
